package com.gmsphixit.app.presentation.feature.packagePicker
                ...
                Row(
                    ...
                    FilledTonalIconButton(
                        ...
                        Icon(
                            ...
                            contentDescription = "Add Manual Package"
                        )
                    }
                    Spacer(modifier = Modifier.width(8.dp))
                    FilledTonalIconButton(
                    ...
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Row(
                                ...
                                TextButton(onClick = { viewModel.toggleManualInput() }) {
                                    Text("Cancel")
                                }
                                Spacer(modifier = Modifier.width(8.dp))
                                TextButton(
                                    onClick = {
                                        viewModel.onManualPackageSubmit(onClick)
                                    },
                                ...
                                state.filteredSections.forEach { section ->
                                    item {
                                        ExpandableSectionCard(
                                            ...
                                            onClick = {
                                                viewModel.toggleSection(section.packageName)
                                            },
                                            loading = viewModel.loadingSections.contains(
                                                section.packageName
                                            ),
...
private fun SectionPackagesLazy(
    ...
    Column(
        ...
        packages.forEach { pkg ->
            PackageItem(pkg) { onSelect(pkg, appName) }
        }
