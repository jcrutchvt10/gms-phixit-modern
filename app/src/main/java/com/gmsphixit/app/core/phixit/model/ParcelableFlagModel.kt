package com.gmsphixit.app.core.phixit.model
...
abstract class ParcelableFlagModel : Parcelable {
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<ParcelableFlagModel> =
            object : Parcelable.Creator<ParcelableFlagModel> {
...
data class ParcelableBoolFlag(override val name: String, override val value: Boolean) :
    ParcelableFlagModel()

data class ParcelableIntFlag(override val name: String, override val value: Long) :
    ParcelableFlagModel()

data class ParcelableFloatFlag(override val name: String, override val value: Long) :
    ParcelableFlagModel()

data class ParcelableStringFlag(override val name: String, override val value: String) :
    ParcelableFlagModel()

data class ParcelableExtensionFlag(override val name: String, override val value: ByteArray) :
    ParcelableFlagModel()
